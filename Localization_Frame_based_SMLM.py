...
#-----------------------------------------------------------------------------
# *VERSION INFORMATION
# Created on November 23rd 2020, last updated on September 18th 2025
...
#       Column 2: y (in optical pixels or in nm, see the parameter 'distances_pix_or_nm')
#       Column 3: x (in optical pixels or in nm, see the parameter 'distances_pix_or_nm')
#       Column 4: PSF y width (in optical pixels or in nm, see the parameter 'distances_pix_or_nm')
#       Column 5: PSF x width (in optical pixels or in nm, see the parameter 'distances_pix_or_nm')
#       Column 6: amplitude of the fitted Gaussian (in photons)
#       Column 7: background (i.e. offset of the fitted Gaussian) (in photons)
#       Column 8: fitting error (defined as err=1-R^2, i.e. a good localization is close to 0, and a bad localization is close to 1)
#       Column 9: photon count (i.e. number of photons intedrated over the whole fitting area, background subtracted) (in photons)
